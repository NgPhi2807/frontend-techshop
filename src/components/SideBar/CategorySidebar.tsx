                    ...
                    {navItems.map((item, index) => {
                        ...
                        return (
                            <li key={index}>
                                <a
                                    href={item.href}
                                    className={`flex cursor-pointer items-center rounded-lg p-3 font-medium text-gray-700 transition-colors hover:bg-red-50 hover:text-red-600 ${isActive ? "bg-red-50 text-red-600" : ""
                                        }`}
                                ...
                                >
                                    ...
                                    {item.key && (
                                        <ChevronRight
                                            className={`ml-2 h-4 w-4 ${isActive ? "text-red-600" : "text-gray-400"
                                                }`}
                                            strokeWidth={2}
                                        />
                                    )}
