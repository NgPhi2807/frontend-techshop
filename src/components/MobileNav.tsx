...
const MobileNav: React.FC = () => {
    // isVisible chỉ dùng cho nút "Lên đầu"
    ...
    useEffect(() => {
        const handleScroll = () => {
            // Hiển thị khi cuộn xuống hơn 100px
    ...
    const appButtonClasses = `fixed bottom-32 right-2 lg:right-8 transition-all duration-300 z-[9999] opacity-100`;

    const navClasses = `fixed bottom-5 right-4 flex flex-col gap-3 transition-all duration-300 z-[9999] opacity-100`;
        ...
        <>
            ...
            {showQR && (
                <>
                    ...
                    />
                    <div className="fixed bottom-[250px] right-4 bg-white rounded-lg shadow-2xl p-4 text-center z-[9999] w-64">
            ...
            {showContact && (
                ...
                >      
                    ...
                    <a 
                        ...
                        className="flex items-center gap-2 rounded-md hover:bg-gray-100 font-semibold text-blue-600 mt-4"
                        onClick={() => setShowContact(false)}
                    >
            ...
            {/* Nút Tải App Ngay (luôn hiển thị) */}
            ...
            {/* Khối chứa nút Liên hệ và Lên đầu */}
            <div id="mobile-nav" className={navClasses}>
                
                {/* 1. Nút Lên đầu (Đã di chuyển lên trên) */}
                <button
                    onClick={scrollToTop}
                    className={`
                ...
                {/* 2. Nút Liên hệ (Đã di chuyển xuống dưới) */}
                <button
